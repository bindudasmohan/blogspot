  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ route('categorise',$c->id) }}">{{ $c->CategoryName }}</a>
        </li>
       @endforeach
      </ul>
...
<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <img src="./upload/{{ $t->Image }}" class="d-block w-100" alt="...">
    ...
    <div class="col-md-2 col-lg-3">
        <div class="card">
            ...
            <div class="card-body"><h5>{{ $art->Title }}</h5>
                ...
                <a href="{{ route('details',$art->id) }}" class="card-link text-center">More..</a>
            </div>
        </div>
    </div>
    @endforeach
